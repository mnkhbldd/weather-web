...
export const WeatherCard = () => {
  return (
    <div className="w-[414px] h-[832px] bg-gray-900 rounded-[48px] backdrop-blur-md z-50 flex justify-center pt-2">
      <div className="w-[398px] h-[504px] rounded-[42px] bg-gradient-to-b from-gray-800 to-transparent flex flex-col items-center">
        <div className="flex items-center justify-center w-full pr-[40px] pt-[64px] pl-[48px]   ">
          ...
          <MdOutlineLocationOn className="fill-white size-8" />
        </div>
        <img
          className="size-[264.891px]"
        ...
        <div className="w-full pl-[48px] ">
          <p className="text-[144px] font-bold bg-gradient-to-b from-gray-300 to-gray-600 text-transparent bg-clip-text">
            17
          </p>
          <p className="text-[24px] font-bold text-[#777CCE]">Clear</p>
        </div>
